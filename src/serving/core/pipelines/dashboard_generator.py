...
def _get_price_chart_data(ticker: str) -> dict[str, Any] | None:
...
def _get_page_json(ticker: str, run_date: str) -> dict[str, Any] | None:
    """
    ...
    try:
        ...
        logging.warning(
            f"[{ticker}] SEO Page JSON not found or invalid at {blob_name}: {e}"
        )
    return None


def process_prep_file(prep_blob_name: str) -> str | None:
    """
    ...
    try:
        ...
        if page_json:
            ...
            analysis_section["summary"] = {
                ...
                "confidence": page_json.get("tradeSetup", {}).get(
                    "confidence", "Medium"
                ),
            }
            ...
            analysis_section["fundamentalThesis"] = {
                ...
                "catalysts": content_blocks.get(
                    "catalysts", page_json.get("tradeSetup", {}).get("catalyst", [])
                ),
            }
            if isinstance(analysis_section["fundamentalThesis"]["catalysts"], str):
                analysis_section["fundamentalThesis"]["catalysts"] = [
                    analysis_section["fundamentalThesis"]["catalysts"]
                ]
            ...
            analysis_section = {
                ...
                "optionsBrief": {
                    ...
                    "content": "<p>Options data is currently processing.</p>",
                },
                "fundamentalThesis": {
                    "headline": "Analysis Pending",
                    "content": "<p>Fundamental data is processing.</p>",
                },
                "tradeSetup": {},
                "marketStructure": {},
                "fullAnalysis": {},
