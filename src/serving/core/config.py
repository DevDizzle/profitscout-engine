...
DESTINATION_GCS_BUCKET_NAME = os.environ.get(
    "DESTINATION_GCS_BUCKET_NAME", "profit-scout"
)
...
OPTIONS_CANDIDATES_TABLE_ID = (
    f"{SOURCE_PROJECT_ID}.{BIGQUERY_DATASET}.options_candidates"
)
...
BUNDLER_ASSET_METADATA_TABLE_ID = (
    f"{DESTINATION_PROJECT_ID}.{BQ_DATASET_BUNDLER}.{ASSET_METADATA_TABLE}"
)
BUNDLER_STOCK_METADATA_TABLE_ID = (
    f"{SOURCE_PROJECT_ID}.{BQ_DATASET_BUNDLER}.{STOCK_METADATA_TABLE}"
)
BUNDLER_SCORES_TABLE_ID = (
    f"{SOURCE_PROJECT_ID}.{BQ_DATASET_BUNDLER}.{SCORES_TABLE_NAME}"
)

SOURCE_CALENDAR_EVENTS_TABLE_ID = (
    f"{SOURCE_PROJECT_ID}.{BQ_DATASET_BUNDLER}.{CALENDAR_EVENTS_TABLE}"
)
...
SOURCE_WINNERS_DASHBOARD_TABLE_ID = (
    f"{SOURCE_PROJECT_ID}.{BQ_DATASET_BUNDLER}.{WINNERS_DASHBOARD_TABLE}"
)
DESTINATION_WINNERS_DASHBOARD_TABLE_ID = (
    f"{DESTINATION_PROJECT_ID}.{BQ_DATASET_BUNDLER}.{WINNERS_DASHBOARD_TABLE}"
)

SOURCE_OPTIONS_CHAIN_TABLE_ID = (
    f"{SOURCE_PROJECT_ID}.{BQ_DATASET_BUNDLER}.{OPTIONS_CHAIN_TABLE}"
)
DESTINATION_OPTIONS_CHAIN_TABLE_ID = (
    f"{DESTINATION_PROJECT_ID}.{BQ_DATASET_BUNDLER}.{OPTIONS_CHAIN_TABLE}"
)

SOURCE_PRICE_DATA_TABLE_ID = (
    f"{SOURCE_PROJECT_ID}.{BQ_DATASET_BUNDLER}.{PRICE_DATA_TABLE}"
)
DESTINATION_PRICE_DATA_TABLE_ID = (
    f"{DESTINATION_PROJECT_ID}.{BQ_DATASET_BUNDLER}.{PRICE_DATA_TABLE}"
)
