...
def run_execution_test():
    print("="*80)
    print("TASK 4D (Alt Gate): EXECUTION VIABILITY ON GATED COHORT")
    print("Target Cohort: SCORE_GTE_2 | Gate: V>25 | OI>50")
    ...
    WHERE premium_score >= 2 
      ...
      AND (recommended_volume >= 25 OR recommended_oi >= 50)
