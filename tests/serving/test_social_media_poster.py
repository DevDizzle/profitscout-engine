...
from src.serving.core import config
...
class TestSocialMediaPoster(unittest.TestCase):
    ...
    def test_run_pipeline(self, mock_read_blob, mock_generate, mock_x_client_cls, mock_firestore_cls, mock_bq_cls):
        # Setup mocks
        ...
        # Mock Vertex AI
        mock_generate.return_value = '"$TSLA is looking good! 🚀 https://gammarips.com/TSLA"'
        ...
        mock_x_client.post_tweet.assert_called_with("$TSLA is looking good! 🚀 https://gammarips.com/TSLA")
